...
public class RepoFragment extends Fragment {
    public static final String TOTAL_REPO = "total_repo" ;
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        User repo = getActivity().getIntent().getParcelableExtra(TOTAL_REPO);

        View view = inflater.inflate(R.layout.fragment_repo, container, false);
        TextView text = (TextView) view.findViewById(R.id.total_repo);

        if (repo != null){
            text.setText(repo.getRepositori());
        }
        return view;
    }
}